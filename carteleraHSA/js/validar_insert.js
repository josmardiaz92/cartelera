...
const elementosInsert=document.querySelectorAll('.validarInsert');
...
const valoresok={
    ubicacion: '"Por favor, Seleccione una ubicación de pnatalla donde se verá el archivo."',
    area: '"Por favor, Seleccione el área del hospital donde se verá el archivo."',
    est_mul: '"Por favor, Seleccione un estado para el archivo',
    ubi_mul: '"Por favor, Seleccione una ubicación de pnatalla donde se verá el archivo."',
    are_mul: '"Por favor, Seleccione el área del hospital donde se verá el archivo."'
}
...
const expresionesRegulares = {
    ubicacion: /^[A-Za-zÀ-ÖØ-öø-ÿ\s']+$/i,
    area: /^[A-Za-zÀ-ÖØ-öø-ÿ\s' 0-9]+$/i,
    est_mul: /^[A-Za-zÀ-ÖØ-öø-ÿ\s']+$/i,
    ubi_mul: /^[A-Za-zÀ-ÖØ-öø-ÿ\s']+$/i,
    are_mul: /^[A-Za-zÀ-ÖØ-öø-ÿ\s' 0-9]+$/i
};
...
const validarCampo=(campo,valor,expresionesRegular,nombreCampo)=>{
    ...
    campo.classList.toggle("invalidUpdate", !valido);
